...
public final class ParameterSpec {
  ...
  /**
   * Create a copy of the parameter specification from the variable element.
   *
  ...
  /**
   * Create a builder with a copy of this parameter's annotations and modifiers.
   *
  ...
  /**
   * Parameter Specification Builder.
   */
  public static final class Builder {
    ...
    /**
     * Finish and return the parameter specification.
     *
     * @return the parameter specification
     */
