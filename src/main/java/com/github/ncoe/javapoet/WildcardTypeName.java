...
/**
 * A typename having {@code ?} as part of it, such as {@code ? extends $T} or {@code ? super $T}.
 */
public final class WildcardTypeName extends TypeName {
  ...
  /**
   * Returns a type that represents an unknown type that extends {@code bound}. For example,
   * if {@code bound} is {@code CharSequence.class}, this returns {@code ? extends CharSequence}.
   * If {@code bound} is {@code Object.class}, this returns {@code ?},
   * which is shorthand for {@code ? extends Object}.
   *
   * @param upperBound the upper bound
   * @return the wildcard type name
   */
  ...
  /**
   * * Returns a type that represents an unknown type that extends {@code upperBound}.
   *
   * @param upperBound the upper bound
   ...
   * For example, if {@code bound} is {@code String.class}, this returns {@code ? super String}.
   *
  ...
  /**
   * Returns a type that represents an unknown supertype of {@code bound}.
   * For example, if {@code lowerBound} is {@code String.class},
  ...
  /**
   * Get a typename using the wildcard type.
   *
   * @param mirror the mirror
   * @return the type name
   */
  public static TypeName get(javax.lang.model.type.WildcardType mirror) {
    return get(mirror, Collections.emptyMap());
  }
  ...
  /**
   * Get a typename using a wildcard type.
   *
   * @param wildcardName the wildcard name
   * @return the type name
   */
  public static TypeName get(WildcardType wildcardName) {
    return get(wildcardName, Collections.emptyMap());
  }
}
