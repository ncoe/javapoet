...
/**
 * Combine a method return type with documentation.
 */
public final class ReturnSpec {
  private final TypeName type;
  private final CodeBlock javadoc;

  private ReturnSpec(Builder builder) {
  ...
  public static final class Builder {
    ...
    /**
     * Finish and return the return value specification.
     *
     * @return the return value specification
     */
    public ReturnSpec build() {
      return new ReturnSpec(this);
    }
  }
}
