...
public final class ParameterizedTypeName extends TypeName {
  ...
  private ParameterizedTypeName(
    ParameterizedTypeName enclosingType, ClassName rawType,
  ...
  /**
   * Returns a new {@link ParameterizedTypeName} instance
   * for the specified {@code name} as nested inside this class.
   *
   * @param name the name
  ...
  static ParameterizedTypeName get(ParameterizedType type, Map<Type, TypeVariableName> map) {
    ...
    ParameterizedType ownerType = (type.getOwnerType() instanceof ParameterizedType paramType)
