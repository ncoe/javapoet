...
public class TypeNameTest {
  ...
  private static TestGeneric<String>.Inner testGenericStringInner() {
    return null;
  }

  private static TestGeneric<Integer>.Inner testGenericIntInner() {
    return null;
  }

  private static TestGeneric<Short>.InnerGeneric<Long> testGenericInnerLong() {
    return null;
  }

  private static TestGeneric<Short>.InnerGeneric<Integer> testGenericInnerInt() {
    return null;
  }

  private static TestGeneric.NestedNonGeneric testNestedNonGeneric() {
    return null;
  }
  ...
  public void genericType() throws Exception {
    ...
    ParameterizedTypeName.get(new ParameterizedType() {
      @Override
  ...
  @Test
  public void arrayComponent() {
    assertThat(TypeName.arrayComponent(ArrayTypeName.get(Byte.class))).isNull();
    assertThat(TypeName.arrayComponent(TypeName.FLOAT)).isNull();
  }

  @Test
  public void parameterizedTypeName() {
    ParameterizedTypeName typeName = ParameterizedTypeName.get(List.class, String.class);
    assertThat(typeName.getRawType()).isNotNull();
    assertThat(typeName.withoutAnnotations()).isNotNull();
    assertThat(typeName.nestedClass("nest")).isNotNull();
  }
}
