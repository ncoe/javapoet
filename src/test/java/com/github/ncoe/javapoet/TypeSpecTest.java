...
public final class TypeSpecTest {
  private final String tacosPackage = "com.github.ncoe.tacos";
  private static final String donutsPackage = "com.github.ncoe.donuts";
   ...
   * imports. github.com/square/javapoet/issues/422
   */
  @Test
  ...
  /**
   * github.com/square/javapoet/issues/193
   */
  @Test
  ...
  /**
   * github.com/square/javapoet/issues/253
   */
  @Test
  ...
  @Test
  public void typeVariableWithBounds1() {
    AnnotationSpec a = AnnotationSpec.builder(ClassName.get("com.github.ncoe.tacos", "A")).build();
    TypeVariableName p = TypeVariableName.get("P", Number.class);
  ...
  @Test
  public void typeVariableWithBounds2() {
    AnnotationSpec a = AnnotationSpec.builder(ClassName.get("com.github.ncoe.tacos", "A")).build();
    TypeVariableName p = TypeVariableName.get("P", Number.class);
    TypeVariableName q = (TypeVariableName) TypeVariableName.get("Q", Number.class).annotated(a);
    TypeSpec typeSpec = TypeSpec.classBuilder("Location")
      .addTypeVariable(p.withBounds(ClassName.get(Comparable.class)))
      .addTypeVariable(q.withBounds(ClassName.get(Comparable.class)))
      .addField(p, "x")
      .addField(q, "y")
      .build();
    assertThat(toString(typeSpec)).isEqualTo("""
  ...
  public void referencedAndDeclaredSimpleNamesConflict() {
    ...
    assertThat(toString(top)).isEqualTo("""
      ...
      import com.github.ncoe.donuts.Bottom;
      ...
      class Top {
        ...
        com.github.ncoe.donuts.Top externalTop;
        ...
        class Middle {
          ...
          com.github.ncoe.donuts.Bottom externalBottom;
  ...
  public void simpleNamesConflictInThisAndOtherPackage() {
    ...
    assertThat(toString(gen)).isEqualTo("""
      ...
      class Gen {
        ...
        com.github.ncoe.donuts.Other externalOther;
      }
      """);
  }
  ...
  public void simpleNameConflictsWithTypeVariable() {
    ClassName inPackage = ClassName.get("com.github.ncoe.tacos", "InPackage");
    ClassName otherType = ClassName.get("com.other", "OtherType");
    ClassName methodInPackage = ClassName.get("com.github.ncoe.tacos", "MethodInPackage");
    ...
    assertThat(toString(gen)).isEqualTo("""
      ...
      class Gen<InPackage, OtherType> {
        com.github.ncoe.tacos.InPackage inPackage;
      
        com.other.OtherType otherType;
      
        <MethodInPackage, MethodOtherType> void withTypeVariables() {
          com.github.ncoe.tacos.MethodInPackage inPackage = null;
        ...
        void hasSimpleNameThatWasPreviouslyMasked() {
          com.github.ncoe.tacos.InPackage inPackage = null;
        }
      }
      """);
  }
  ...
  public void originatingElementsIncludesThoseOfNestedTypes() {
    ...
    TypeSpec outer = TypeSpec.classBuilder("Outer")
      ...
      .addType(TypeSpec.classBuilder("Inner")
        ...
        .build())
      .build();
    assertThat(outer.getOriginatingElements()).containsExactly(outerElement, innerElement);
  }
  ...
  public void constructorToString() {
    ...
    assertThat(constructor.toString()).isEqualTo("""
      public Constructor(com.github.ncoe.tacos.Taco taco) {
        this.taco = taco;
      }
      """);
  }
  ...
  public void parameterToString() {
    ...
    assertThat(parameter.toString())
      .isEqualTo("@javax.annotation.Nullable final com.github.ncoe.tacos.Taco taco");
  }
  ...
  public void tryCatch() {
    TypeSpec taco = TypeSpec.classBuilder("Taco")
      .addMethod(MethodSpec.methodBuilder("addTopping")
        .addParameter(ClassName.get("com.github.ncoe.tacos", "Topping"), "topping")
        .beginControlFlow("try")
        .addCode("/* do something tricky with the topping */\n")
        .nextControlFlow("catch ($T e)",
          ClassName.get("com.github.ncoe.tacos", "IllegalToppingException"))
        .endControlFlow()
        .build())
      .build();
    assertThat(toString(taco)).isEqualTo("""
  ...
  public void initializersToBuilder() {
    ...
    assertThat(taco.getOriginatingElements())
      .containsExactlyElementsIn(recreatedTaco.getOriginatingElements());
    assertThat(taco.getAlwaysQualifiedNames())
      .containsExactlyElementsIn(recreatedTaco.getAlwaysQualifiedNames());
  ...
  public void classNameFactories() {
    ...
    assertThat(TypeSpec.classBuilder(className).build().getName()).isEqualTo("Example");
  ...
  public void modifyFields() {
    ...
    builder.getFieldSpecs().remove(0);
    assertThat(builder.build().getFieldSpecs()).isEmpty();
  }
  ...
  public void modifySuperinterfaces() {
    ...
    builder.getSuperinterfaces().clear();
    assertThat(builder.build().getSuperinterfaces()).isEmpty();
  }
  ...
  public void modifyMethods() {
    ...
    builder.getMethodSpecs().clear();
    assertThat(builder.build().getMethodSpecs()).isEmpty();
  }
  ...
  public void modifyTypes() {
    ...
    builder.getTypeSpecs().clear();
    assertThat(builder.build().getTypeSpecs()).isEmpty();
  }
  ...
  public void modifyEnumConstants() {
    ...
    builder.getEnumConstants().remove("WUT");
    assertThat(builder.build().getEnumConstants()).containsExactly("BELL", constantType);
  }
  ...
  public void modifyOriginatingElements() {
    ...
    builder.getOriginatingElements().clear();
    assertThat(builder.build().getOriginatingElements()).isEmpty();
  }
  ...
  private <E extends Enum<E>> E generic(E[] values) {
    return values[0];
  }
  ...
  public void genericType() throws NoSuchMethodException {
    ...
    Type grt = recursiveEnum.getGenericReturnType();
    if (grt instanceof java.lang.reflect.TypeVariable<?> typeVariable) {
      TypeVariableName.get(typeVariable);
    } else {
      fail("how can the right type be obtained?");
    }
  }
  ...
  public void getAlwaysQualifiedNames(){
    Set<String> alwaysQualifiedNames = TypeSpec
      ...
      .getAlwaysQualifiedNames();
    assertThat(alwaysQualifiedNames.size()).isEqualTo(1);
  }
  ...
  public void typeProperties(){
    ...
    assertThat(typeSpec.getInitializerBlock()).isNotNull();
    assertThat(typeSpec.getJavadoc()).isNotNull();
    assertThat(typeSpec.getStaticBlock()).isNotNull();
    assertThat(typeSpec.getSuperclass()).isNotNull();
    assertThat(typeSpec.hasModifier(Modifier.PUBLIC)).isTrue();
  }
