...
public final class JavaFileTest {
  ...
  public void importStaticForCrazyFormatsWorks() {
    ...
    JavaFile.builder("com.github.ncoe.tacos",
  ...
  public void annotatedTypeParam() {
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .addField(ParameterizedTypeName.get(ClassName.get(List.class),
            ClassName.get("com.github.ncoe.meat", "Chorizo")
              .annotated(AnnotationSpec.builder(ClassName.get("com.github.ncoe.tacos", "Spicy"))
                .build())), "chorizo")
          .build())
      .build()
      .toString();
    assertThat(source).isEqualTo("""
      ...
      import com.github.ncoe.meat.Chorizo;
      import java.util.List;
  ...
  public void skipJavaLangImportsWithConflictingClassLast() {
    ...
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          ...
          .addField(ClassName.get("com.github.ncoe.soda", "Float"), "beverage")
          .build())
  ...
  public void skipJavaLangImportsWithConflictingClassFirst() {
    // Whatever is used first wins! In this case the Float in com.github.ncoe.soda is imported.
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .addField(ClassName.get("com.github.ncoe.soda", "Float"), "beverage")
          .addField(ClassName.get("java.lang", "Float"), "litres")
        ...
        TypeSpec.classBuilder("A")
          .addType(TypeSpec.classBuilder("B")
            ...
            .addType(TypeSpec.classBuilder("C")
              .addField(ClassName.get("com.github.ncoe.tacos", "A", "Twin", "D"), "d")
              .build())
            .build())
  ...
  public void nestedClassAndSuperclassShareName() {
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .superclass(ClassName.get("com.github.ncoe.wire", "Message"))
          .addType(TypeSpec.classBuilder("Builder")
            .superclass(ClassName.get("com.github.ncoe.wire", "Message", "Builder"))
            .build())
          .build())
      .build()
      .toString();
    assertThat(source).isEqualTo("""
      ...
      import com.github.ncoe.wire.Message;
  ...
  public void conflictingAnnotationReferencedClass() {
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .addAnnotation(AnnotationSpec.builder(ClassName.get("com.github.ncoe.tacos", "MyAnno"))
    ...
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .superclass(ParameterizedTypeName.get(
            ClassName.get(Comparable.class), ClassName.get("com.github.ncoe.tacos", "Taco")))
          .build())
      .build()
      .toString();
    assertThat(source).isEqualTo("""
  ...
  public void packageClassConflictsWithNestedClass() {
    String source = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .addField(ClassName.get("com.github.ncoe.tacos", "A"), "a")
  ...
  public void modifyStaticImports() {
    JavaFile.Builder builder = JavaFile.builder("com.github.ncoe.tacos",
        TypeSpec.classBuilder("Taco")
          .build())
      .addStaticImport(File.class, "separator");

    builder.getStaticImports().clear();
    builder.getStaticImports().add(File.class.getCanonicalName() + ".separatorChar");
  ...
  public void avoidClashesWithNestedClasses_viaSuperinterfaceType() {
    ...
    assertThat(source).isEqualTo("""
      ...
      import com.github.ncoe.javapoet.JavaFileTest;
      import other.Foo;
      import other.NestedTypeC;
  ...
  public void avoidClashes_parentChild_superclass_type() {
    String source = JavaFile.builder("com.github.ncoe.javapoet",
