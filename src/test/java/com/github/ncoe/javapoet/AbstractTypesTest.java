...
public abstract class AbstractTypesTest {
  ...
  public void errorTypes() {
    JavaFileObject hasErrorTypes =
      JavaFileObjects.forSourceLines(
        "com.github.ncoe.tacos.ErrorTypes",
    ...
    Compilation compilation = javac().withProcessors(new AbstractProcessor() {
      ...
      public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        TypeElement classFile =
          processingEnv.getElementUtils().getTypeElement("com.github.ncoe.tacos.ErrorTypes");
  ...
  public void getTypeVariableTypeMirror() {
    ...
    assertThat(((TypeVariableName) TypeName.get(typeVariables.get(4).asType())).getBounds())
