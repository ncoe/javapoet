...
public final class ClassNameTest {
  ...
  public void bestGuessForString_nestedClass() {
    ...
    assertThat(ClassName.bestGuess(OuterClass.InnerClass.class.getCanonicalName()))
      .isEqualTo(ClassName.get("com.github.ncoe.javapoet",
  ...
  public void classNameFromTypeElement() {
    ...
    assertThat(ClassName.get(outer).toString()).isEqualTo("com.github.ncoe.javapoet.ClassNameTest.$Outer");
    TypeElement inner = elements.getTypeElement($Outer.$Inner.class.getCanonicalName());
    assertThat(ClassName.get(inner).toString()).isEqualTo("com.github.ncoe.javapoet.ClassNameTest.$Outer.$Inner");
  }
  ...
  public void classNameFromTypeElementDoesntUseGetKind() {
    ...
    assertThat(ClassName.get(preventGetKind(outer)).toString())
      .isEqualTo("com.github.ncoe.javapoet.ClassNameTest.$Outer");
    TypeElement inner = elements.getTypeElement($Outer.$Inner.class.getCanonicalName());
    assertThat(ClassName.get(preventGetKind(inner)).toString())
      .isEqualTo("com.github.ncoe.javapoet.ClassNameTest.$Outer.$Inner");
  }
  ...
  public void classNameFromClass() {
    ...
    assertThat(ClassName.get(OuterClass.InnerClass.class).toString())
      .isEqualTo("com.github.ncoe.javapoet.ClassNameTest.OuterClass.InnerClass");
    assertThat((ClassName.get(new Object() {
    }.getClass())).toString())
      .isEqualTo("com.github.ncoe.javapoet.ClassNameTest$1");
    assertThat((ClassName.get(new Object() {
      final Object inner = new Object() {
      };
    }.inner.getClass())).toString())
      .isEqualTo("com.github.ncoe.javapoet.ClassNameTest$2$1");
