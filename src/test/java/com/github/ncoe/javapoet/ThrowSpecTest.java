...
public class ThrowSpecTest {
  @SuppressWarnings({"ConstantValue", "EqualsWithItself", "EqualsBetweenInconvertibleTypes"})
  @Test
  public void equalsAndHashCode() {
    ThrowSpec a = ThrowSpec.builder(int.class).addJavadoc("some value").build();
    assertThat(a.equals(null)).isFalse();
    assertThat(a.equals(42)).isFalse();
    assertThat(a.equals(a)).isTrue();
    ThrowSpec b = ThrowSpec.builder(int.class).addJavadoc(CodeBlock.of("some value")).build();
    ...
    a = ThrowSpec.builder(int.class).build();
    b = ThrowSpec.builder(int.class).build();
    assertThat(a.equals(b)).isTrue();
    assertThat(a.hashCode()).isEqualTo(b.hashCode());
    assertThat(a.toString()).isEqualTo(b.toString());
  }
