...
public final class AnnotationSpecTest {
  ...
  public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo("""
      ...
      import com.github.ncoe.javapoet.AnnotationSpecTest;
  ...
  public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("com.github.ncoe.javapoet", typeBuilder.build()).build();
  ...
  public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "@com.github.ncoe.javapoet.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
      .isEqualTo(
        "@com.github.ncoe.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
          + "n = {}, m = {}"
          + ")");
  }
  ...
  public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "@com.github.ncoe.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
        + "n = com.github.ncoe.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
        + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "@com.github.ncoe.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
        + "n = {"
        + "com.github.ncoe.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
        + ", com.github.ncoe.javapoet.AnnotationSpecTest.Breakfast.WAFFLES"
        + ", com.github.ncoe.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
        + "})");
  ...
  public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
      "@com.github.ncoe.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
        + "o = com.github.ncoe.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
        + ", p = 1701"
        + ", f = 11.1"
        + ", m = {9, 8, 1, 123}"
        + ", l = java.lang.Override.class"
        + ", j = @com.github.ncoe.javapoet.AnnotationSpecTest.AnnotationA"
        + ", q = @com.github.ncoe.javapoet.AnnotationSpecTest.AnnotationC(\"bar\")"
  ...
  public void modifyMembers() {
    ...
    builder.getMembers().clear();
    builder.getMembers().put("value", List.of(CodeBlock.of("$S", "Bar")));

    assertThat(builder.build().toString()).isEqualTo("@java.lang.SuppressWarnings(\"Bar\")");
  }

  private String toString(TypeSpec typeSpec) {
    return JavaFile.builder("com.github.ncoe.tacos", typeSpec).build().toString();
  }
}
