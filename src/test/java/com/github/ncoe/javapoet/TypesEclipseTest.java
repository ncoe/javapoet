...
public final class TypesEclipseTest extends AbstractTypesTest {
  /**
   * A {@link JUnit4} {@link Rule} that executes tests such that an instances of {@link Elements} and
  ...
  public static final class CompilationRule implements TestRule {
    ...
    private static boolean compile(Iterable<? extends Processor> processors) {
      ...
      JavaFileManager fileManager = compiler.getStandardFileManager(diagnosticCollector, Locale.getDefault(), StandardCharsets.UTF_8);
